...
class ViewController: UIViewController {
    ...
    var headerIsExpended: Bool = true
            ...
            if identifier == "deedDetailsSegue" {
                if isDetailSegueAdd {
                    ...
                    if let indexPath = deedCollectionView.indexPathsForSelectedItems {
                        guard let destinationVC = segue.destination as? TaskDetailViewController else {
                            return
                        }
                ...
                isDetailSegueAdd = false
                guard let destinationVC = segue.destination as? MessageViewController else {
                    return
                }
    ...
    func headerOpacity(_ percentage: CGFloat) {
...
func initData() {
    let testDeed1 = Deed(
        date: Date(),
        desc: "TESTING a very very long long question that might break code",
        question: "CAN I WORK?")
    ...
    let testDeed7 = Deed(
        ...
        desc: "TESTING a very very long long question that might break code",
        question: "CAN I WORK?",
        image: UIImage.init(named: "branch")!)
